...
//execute actions for the menu bar tools.
...
void ToolMain::onActionXYManipulation()
{
	m_d3dRenderer.SetManipulationState(XZ);
}

void ToolMain::onActionClear()
{
	m_d3dRenderer.SetManipulationState(None);
	m_d3dRenderer.ClearSelectedObject();
}
...
void ToolMain::onActionTerrainGrid()
{
	m_d3dRenderer.ToggleTerrainWireframe();
}
